...
public class ContextoSimulacion {
    ...
    public void incrementarComparaciones() { totalDeComparaciones++; }
    public void sumarTiempoEspera(int tiempo) { tiempoTotalDeEspera += tiempo; }
    public void incrementarPedidosAtendidos() { numeroDePedidosAtendidos++; }
