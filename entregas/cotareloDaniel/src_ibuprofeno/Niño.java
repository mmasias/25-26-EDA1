...
public class Niño {
    ...
    public void recibirMensaje(String mensaje) {
        ...
        new Console()
                .writeln("[" + nombre + "] recibe [" + mensaje + "] y ha escrito [" + pizarrin.leerMensaje() + "]");
    }
    ...
    private String modificarMensaje(String mensaje) {
        ...
        for (int i = 0; i < errores; i++) {
            if (mensaje.length() > 0) {
                ...
                mensaje = mensaje.substring(0, indiceAleatorio) + letraAleatoria
                        + mensaje.substring(indiceAleatorio + 1);
            }
        }
        return mensaje;
    }
