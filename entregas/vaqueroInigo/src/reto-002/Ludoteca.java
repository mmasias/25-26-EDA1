...
""");
    ...
    private void simularInicioJuego() {
        if (lydia.getCantidadNiños() < 5) {
            ...
            Ninio[] transferidos = lydia.transferirNiños();
    ...
    private void mostrarConteo() {
        ...
        System.out.printf("Total: %d niños%n",
                lydia.getCantidadNiños() + aisha.getCantidadNiños() + dalsy.getCantidadNinios());
    }
    ...
    private void alarmaIncendios() {
        ...
        Niño[] fromAisha = aisha.transferirNiños();
        Niño[] fromDalsy = dalsy.transferirNiños();
    ...
    private void jugarTelefonoDescacharrado() {
        ...
        aisha.copiarMensajeAlPrimerNiño(mensajeInicial);


        int minutos = 1; 
        for (int i = 1; i < aisha.getCantidadNiños(); i++) {
            System.out.println("Minuto " + minutos + ": el niño " + (i) + " muestra su pizarrín al siguiente");
            String recibido = aisha.leerMensajeDeNinio(i - 1);
            aisha.copiarMensajeDeNiñoA(i - 1, i);
            minutos++;
        }


        String mensajeFinal = aisha.leerMensajeDeNiño(aisha.getCantidadNinios() - 1);
